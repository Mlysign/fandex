      ...
      body: [
        ...
        "Die meisten dieser Anbieter sitzen in den USA. Was das für Ihre Daten bedeutet, hängt davon ab, um welchen Anbieter es geht. Deshalb hier die Fälle einzeln statt einer pauschalen Aussage:",
        {
          list: [
            ...
            "Anbieter, die Daten im Auftrag von Fandex verarbeiten. Das sind Railway (Hosting einschließlich der Datenbank) und Cloudflare (DNS sowie die Zustellung des Postfachs hello@fandex.org). Die Datenbank liegt in den Niederlanden, in der Region europe-west4 von Railway. Beide Unternehmen sitzen in den USA und ihre Mitarbeitenden können auf das zugreifen, was sie für uns hosten; das gilt als Übermittlung. Beide sind daher nach dem EU-US Data Privacy Framework selbstzertifiziert und verpflichten sich zusätzlich auf die Standardvertragsklauseln der Europäischen Kommission für den Fall, dass diese Zertifizierung entfällt. Stand August 2026. Zertifizierungen können widerrufen werden, dies wird daher nachgeprüft und nicht unterstellt.",
          ],
        },
