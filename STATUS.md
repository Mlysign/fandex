...
| Fandex Score — visible per-item taste match (H5) | 🔵 **H5.1–H5.3 done** (2026-07-19) — **now LIVE**: score badge on Library/Wishlist/Discover cards + expandable breakdown on the item detail page. Not yet manually verified logged-in in a real browser (needs your own OAuth login) — please sanity-check it looks right. Design in [docs/fandex-score.md](docs/fandex-score.md), H5.4 (dev backend) + H5.5 (calibrate) remain in TASKS.md |
