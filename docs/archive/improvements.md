# Improvements audit — archive (all findings resolved)

Moved out of the root [IMPROVEMENTS.md](../../IMPROVEMENTS.md) 2026-07-18 —
every finding below (D#, A#, U#, P#, S#) is ✅ resolved (execution history is
in [docs/archive/completed-phases.md](completed-phases.md) and TASKS.md). Kept
verbatim as the "why" record behind each fix. If you're planning new work, you
want TASKS.md instead.
