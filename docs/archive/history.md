...
## Small-tasks batch — DONE items — 2026-07-27 (ID `S#`)

Compiled after H1 closed, as a queue of low-blast-radius work; none touched `migrations.ts`, `matcher.ts`'s write paths, sync/pull adapters, or auth/session code. (Open items S2/S4/S9/S10 stay in TASKS.md.)
