...
✅ **PL1 through PL5 all shipped on 2026-08-23**, tests 1006 green and the build clean. Still open: **PL6** only (a colour-coding leftover, small). The done ones are one-line pointers below; their full reasoning is in the commit messages and in the [archive](docs/archive/history.md) (grep `PL1 / PL2 / PL3 / PL5`).
